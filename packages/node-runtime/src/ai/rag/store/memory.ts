/**
 * In-memory vector store (LRU cache, platform-agnostic)
 */
...
export function initMemoryStoreLogger(logger: RagLogger): void {
  _logger = logger
}
...
export class MemoryVectorStore implements IVectorStore {
  ...
  async clear(): Promise<void> {
    ...
    this.head = null
    this.tail = null
    _logger.info('Memory Store', 'All vectors cleared')
  }
  ...
  async close(): Promise<void> {
    _logger.info('Memory Store', 'Closed')
  }
}
